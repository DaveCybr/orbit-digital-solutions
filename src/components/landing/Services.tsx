        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
          {services.map((service, index) => (
            ...
            >
              <Link
                to={service.link}
                className="group block bg-card rounded-2xl p-6 md:p-8 border border-border card-hover h-full"
              >
